...
class Log
{
  ...
  public:
    template <typename T>
    static void d(const char * const module, const T & value)
    {
    ...
    template <typename T>
    static void i(const char * const module, const T & value)
    {
        std::ostringstream oss;
        oss << value;
    ...
    template <typename T>
    static void w(const char * const module, const T & value)
    {
        std::ostringstream oss;
        oss << value;
    ...
    template <typename T>
    static void e(const char * const module, const T & value)
    {
        std::ostringstream oss;
        oss << value;
